        ...
        <div className="flex">
          <div className=" flex flex-col lg:flex-row justify-center">
            ...
            <div className="flex flex-col w-full mt-14 lg:mt-0 text-grey text-base lg:text-lg  lg:w-2/5">
              ...
              <p className="mb-2">
                This is an education website which teaches students different
                kinds of courses. This website is very complicated.
              </p>
              <p className="mb-2">
                It has many features such as admin panel, student panel and
                teacher panel. It has payment control, attendance track and
