      ...
      <main className="flex flex-col justify-center items-center w-full pt-36">
        ...
        <div className="flex flex-col justify-center mt-20 items-center">
          <div className="flex flex-col">
            ...
            <p className="mt-3 tracking-wider text-center text-sm md:text-md flex items-center justify-center text-grey">
          ...
          <div className="flex flex-row justify-between mt-10 items-center">
            ...
            <form className="flex flex-col lg:ml-48">
              <input className="bg-gray-300 py-2 px-4 rounded-2xl focus:outline-none focus:ring-2 focus:bg-white focus:ring-gray-500 mt-4" type="text" placeholder="Your Name" />
              <input className="bg-gray-300 py-2 px-4 rounded-2xl focus:outline-none focus:ring-2 focus:bg-white focus:ring-gray-500 mt-4" type="email" placeholder="Your Email" />
              <textarea className="bg-gray-300 py-2 px-4 rounded-2xl focus:outline-none focus:ring-2 focus:bg-white  focus:ring-gray-500 mt-4" cols="30" rows="5" placeholder="Your Questions..."></textarea>
              <input className="mt-4 rounded-2xl bg-grey text-white py-2 w-1/2 mx-auto hover:bg-darkGrey cursor-pointer" type="submit" />
            </form>
          </div>
        </div>
      </main>
